                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary"><!-- panel panel-primary Starts -->
                        ...
                        <div class="card-body"><!-- panel-body Starts -->
                            <a href="{{ route('product_tags.create') }}" style="color:#ffffff;"> <button
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @php
                                        $i = 1;
                                    @endphp
                                    @foreach ($product_tags as $productscategories)
                                        <tr>
                                            <td>{{ $i++ }}</td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <script type="text/javascript">
                                                    function edit{{ $productscategories->id }}() {
                                                        window.open('{{ route('product_tags.edit', $productscategories->id) }}', '_self');
                                                    };
                                                </script>
