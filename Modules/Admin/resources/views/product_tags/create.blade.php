...
@endpush
@push('Tags')
    {{ Request::path() == 'admin/product_tags/create' ? 'active' : '' }}
    {{ Request::path() == 'admin/product_tags/create' ? 'menu-open' : '' }}
@endpush
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('product_tags.store') }}" method="post">
                            <div class="card-body">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label for="exampleInputFile">{{ __('Image') }} <span
