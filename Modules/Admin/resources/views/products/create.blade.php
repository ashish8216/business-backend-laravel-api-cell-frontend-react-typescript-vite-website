...
@endpush
@push('products')
    {{ Request::path() == 'admin/products/create' ? 'active' : '' }}
    {{ Request::path() == 'admin/products/create' ? 'menu-open' : '' }}
@endpush
@section('content')
                        ...
                        <form action="{{ route('products.store') }}" method="post">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="select2-purple">
                                        <select name="tag[]"
                                            class="form-control select2  @error('tag') is-invalid @enderror" id="tag"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea rows="10" class="form-control " id="video" name="video" placeholder="Enter video"></textarea>
                                    @error('video')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group"><!-- 4 form-group Starts -->
                                    ...
                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="15"
