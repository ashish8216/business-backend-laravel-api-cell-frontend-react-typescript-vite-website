                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary"><!-- panel panel-primary Starts -->
                        ...
                        <div class="card-body"><!-- panel-body Starts -->
                            <a href="{{ route('products.create') }}" style="color:#ffffff;"> <button
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @foreach (explode(',', $product->category) as $category)
                                                    <span class="badge badge-info">{{ trim($category) }}</span>
                                                @endforeach
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-warning " onclick="edit{{ $product->id }}()"><i
                                                        class="fa fa-pencil-alt"> </i> </button>

                                                <button class="btn btn-danger" data-toggle="modal"
                                                    data-target="#confirm-delete{{ $product->id }}"><i class="fa fa-trash">
                                                    </i></button>
                                                ...
                                                <script type="text/javascript">
                                                    function edit{{ $product->id }}() {
                                                        window.open('{{ route('products.edit', $product->id) }}', '_self');
                                                    };
                                                </script>
