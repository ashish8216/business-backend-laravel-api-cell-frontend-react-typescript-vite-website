                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('location') is-invalid @enderror"
                                        id="location" name="location" value="{{ $project->content['location'] }}"
                                ...
                                <div class="form-group">
                                    <label for="Surface Area">{{ __('Surface Area') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control @error('area') is-invalid @enderror"
                                        id="Surface Area" name="area" value="{{ $project->content['area'] }}"
                                ...
                                <div class="form-group">
                                    <label for="Year Completed">{{ __('Year Completed') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control @error('year') is-invalid @enderror"
                                        id="Year Completed" name="year" value="{{ $project->content['year'] }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            ...
                                            <input type="text"
                                                class="form-control @error('image1') is-invalid @enderror" id="thumbnail1"
                                                value="{{ $project->content['image1'] }}" name="image1"
                                                placeholder="Choose file">
                                    ...
                                    @error('image1')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                    <img src="{{ $project->content['image1'] }}" style="max-height:100px;">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="text"
                                                class="form-control @error('image2') is-invalid @enderror" id="thumbnail2"
                                                value="{{ $project->content['image2'] }} " name="image2"
                                                placeholder="Choose file">
                                    ...
                                    @error('image2')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                    <img src="{{ $project->content['image2'] }}" style="max-height:100px;">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            ...
                                            <input type="text"
                                                ...
                                                id="thumbnail3" value="{{ $project->content['image3'] }}" name="image3"
                                                placeholder="Choose file">
                                    ...
                                    @error('image3')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                    <img src="{{ $project->content['image3'] }}" style="max-height:100px;">
                                </div>
