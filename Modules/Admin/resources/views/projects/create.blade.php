                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('area') is-invalid @enderror"
                                        id="Surface Area" name="area" value="{{ old('area') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('year') is-invalid @enderror"
                                        id="Year Completed" name="year" value="{{ old('year') }}"
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('image1') }}" name="image1" placeholder="Choose file">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="text"
                                                ...
                                                value="{{ old('image2') }}" name="image2" placeholder="Choose file">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            ...
                                            <input type="text"
                                                ...
                                                id="thumbnail3" value="{{ old('image3') }}" name="image3"
                                                placeholder="Choose file">
